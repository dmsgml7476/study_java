...
//	
		...
		while(true) {
			...
			if (wit_1 == 5) bingo++; wit_1 =0;
			if (wit_2 == 5) bingo++; wit_2 =0;
			if (wit_3 == 5) bingo++; wit_3 =0;
			if (wit_4 == 5) bingo++; wit_4 =0;
			if (wit_5 == 5) bingo++; wit_5 =0;
			
			if (len_1 == 5) bingo++; len_1 =0;
			if (len_2 == 5) bingo++; len_2 =0;
			if (len_3 == 5) bingo++; len_3 =0;
			if (len_4 == 5) bingo++; len_4 =0;
			if (len_5 == 5) bingo++; len_5 =0;
			
			if (cro_1 == 5) bingo++; cro_1 =0;
			if (cro_2 == 5) bingo++; cro_2 =0;
